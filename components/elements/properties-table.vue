    ...
    <table classs="table">
      ...
      <tbody>
        <tr v-for="property in properties.results" :key="property.id">
          ...
          <td v-if="property.location">
            {{ property.location.street?.slice(0, 30) + "..." }}
          </td>
          ...
          <td v-if="property.status == 0">
            <div class="active-stat text-center">Pending</div>
          </td>
          <td v-if="property.status == 1">
            <div class="active-stat text-center">Approved</div>
          </td>
          <td v-if="property.status == 2">
            <div class="deactive-stat text-center">Rejected</div>
          </td>

          <td>
            <button class="btn btn-link" @click="showM(property)">
          ...
          <td>
            <nuxt-link
              ...
              :to="`/tour/create/${property.id}`"
            >
              <b-button
                :style="{ fontSize: '16px' }"
                variant="success"
                class="btn-labeled py-1"
                size="sm"
                >Create VR</b-button
              >
            </nuxt-link>
