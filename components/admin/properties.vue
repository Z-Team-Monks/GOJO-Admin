            ...
            <div class="cat-card mb-4 mr-2 shadow-sm">
              <div class="card-body">
                <div class="row">
                  ...
                  <div
                    class="col-sm-2 edit-icon mr-1"
                    @click="showAddModal(category, 'editC')"
                  >
                    <i class="mdi mdi-account-edit"></i>
                  </div>

                  <div
                    class="col-sm-2 delete-icon"
                    @click="showAddModal1(category, 'deleteC')"
                  >
            ...
            <div class="cat-card mb-4 mr-2 shadow-sm">
              <div class="card-body">
                <div class="row">
                  ...
                  <div
                    class="col-sm-2 edit-icon mr-1"
                    @click="showAddModal(facility, 'editF')"
                  >
                    <i class="mdi mdi-account-edit"></i>
                  </div>
                  ...
                  <div
                    class="col-sm-2 delete-icon"
                    @click="showAddModal1(facility, 'deleteF')"
                  >
                    <i class="mdi mdi-delete"></i>
                  </div>
                </div>
...
export default {
  ...
  computed: {
    ...
    filteredProperties() {
      ...
      if (this.filter == "rejected") {
        properties.results = properties.results?.filter((p) => p.status == 2);
      }
  ...
  methods: {
    ...
    showAddModal(cate, action) {
      (this.showModal = true), (this.action = action), (this.category = cate);
    },
    showAddModal1(cate, action) {
      (this.showModal1 = true), (this.action1 = action), (this.category = cate);
    },
    cancelModal() {
